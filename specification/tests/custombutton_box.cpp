#include "custombutton_box.h"

//CustomButton_Box::CustomButton_Box() {};
...
QChar CustomButton_Box::getLetterValue() const
{
    return letter;
}

void CustomButton_Box::setLetterValue(const QChar &value)
{
    letter = value;
}
