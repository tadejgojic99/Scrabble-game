...
void Deck::shuffleDeck() {
    //std::random_shuffle(deck.begin(), deck.end());  // ovo iz nekog razloga ne radi, pa sam morao sam da implementiram
...
//    return topCard;      // ovaj pristup takodje nije radio, iz nekog razloga
